...
namespace Basics.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Authenticate()
        {
            ...
            {
                new Claim(ClaimTypes.Name, "Yash daiya"),
                new Claim(ClaimTypes.Email, "daiyayash1218@gmail.com"),
                new Claim(ClaimTypes.DateOfBirth, "13/01/1999"),
                new Claim(ClaimTypes.Role, "Admin"),
                new Claim(ClaimTypes.Role, "AdminTwo"),
                new Claim(DynamicPolicies.SecurityLevel, "7"),
                new Claim("Teacher.says", "Very Nice student."),
            };

            var licenseClaims = new List<Claim>()
            {
                new Claim(ClaimTypes.Name, "Yash S Daiya"),
